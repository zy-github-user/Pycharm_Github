...
# 图像绘制
plot2 = plt.plot(t, P_predict, 'r', label='具有环境阻力的增长率')

# 加入一条对比线
X1 = np.linspace(0, 105, 105)  # 构造自变量组
...
plt.plot(X, Y, 'b', label='无环境阻力的增长率')  # 绘制指数函数
...
plt.savefig('2019-nCoV_cn_predict_p.png')  # 保存为文件
plt.show()