# -*- coding: utf-8 -*-
# @Time    : 2020/3/13 10:22 上午
# @Author  : yan.zhao
# @FileName: logistic_2.py
# @Software: PyCharm
...
if __name__ == '__main__':
    ...
    plt.scatter(x_show_data, P_confirm, c='green', marker='.', label="confirm")
    plt.plot(x_show_data_all, future_predict, c='red', marker='+', linewidth=1.5, label='furture')
